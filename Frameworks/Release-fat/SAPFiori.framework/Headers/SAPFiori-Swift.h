...
/// view.chartType = .line
/// view.series.colors = [UIColor.preferredFioriColor(forStyle: .negative)]
/// view.categoryAxis.labels.isHidden = true
///
/// \endcode<h2>Theming</h2>
/// Supported <code>TEXT</code> class paths:
/// \code
...
/// <code>UIViewController</code> implementation of the <code>FUIChartFloorplanView</code>.  Should be used when displaying the full-scren Chart Floorplan of the design guidelines.
/// Extends the API of <code>FUIChartFloorplanView</code>.
/// \code
/// ## Usage
/// self.title = "Sales Chart"
/// self.chartView.chartType = .bar
...
/// View produced by <code>FUIChartSummaryView</code>, for each <code>FUIChartSummaryItem</code> supplied by the devloper to the <code>FUIChartSummaryDataSource</code>.
/// important:
...
/// </ul>
/// <h2>Usage</h2>
/// In <code>viewDidLoad()</code> setup the controller:
/// \code
///
...
/// retainedSearchDataSource = DevDetailPanelSearchResultsController(model: self)
///
...
///
///
/// \endcodeManage presenting the controller in <code>viewDidAppear(_:)</code>
/// \code
...
/// }
///
/// \endcodeManage dismissing the controller in <code>viewWillDisappear(_:)</code>
/// \code
